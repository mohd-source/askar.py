...
print("Louvre Artworks:", louvre_artworks)
print("Rijksmuseum Artworks:", rijksmuseum_artworks)
print("\nShared Masterpieces:", shared_masterpieces)
print("\nMaster List of Unique Artworks:", master_list)
print("Total Unique Artworks:", len(master_list))
print("\nMoMA Exclusive Artworks:", exclusive_moma)
